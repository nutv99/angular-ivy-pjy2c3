...
@Component({
  selector: 'app-paymentchannelList',
  templateUrl: './paymentchannelList.component.html',
  styleUrls: ['./paymentchannel.component.css'],
})
export class PaymentchannelListComponent implements OnInit, OnChanges {
  formModal: any;
  pageid: string = '';
  ...
  ngOnInit() {
    ...
    if (this._Activatedroute.snapshot.paramMap.get('pageid')) {
      this.pageid = this.pageid = 'Paymentchannel';
