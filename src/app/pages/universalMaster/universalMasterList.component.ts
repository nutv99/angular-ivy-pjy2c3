...
@Component({
  selector: 'app-universalMasterList',
  templateUrl: './universalMasterList.component.html',
  styleUrls: ['./universalMasterForm.component.scss'],
})
export class UniversalMasterListComponent implements OnInit, OnChanges {
  formModal: any;
  pageid: string = '';
  ...
  ngOnInit() {
    ...
    if (this._Activatedroute.snapshot.paramMap.get('pageid')) {
      this.pageid = this.pageid = 'UniversalMaster';
