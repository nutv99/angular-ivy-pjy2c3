...
import { formModel } from '../../_services/formModel';
...
declare var templateName: string;
...
export class CompanyComponent implements OnInit {
  ...
  ngOnInit() {
    this.myForm = this.fb.group(formModel);
    templateName = '/company.component.html';
