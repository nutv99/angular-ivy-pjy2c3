...
@Component({
  selector: 'app-dropshipList',
  templateUrl: './dropshipList.component.html',
  styleUrls: ['./dropshipForm.component.scss'],
})
export class DropshipListComponent implements OnInit, OnChanges {
  formModal: any;
  pageid: string = '';
  ...
  ngOnInit() {
    ...
    if (this._Activatedroute.snapshot.paramMap.get('pageid')) {
      this.pageid = this.pageid = 'Dropship';
